...
(
    ...
    PRIMARY KEY (id)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT ='测试使用';
...
INSERT INTO gen_base_class (package_name, code, fields, remark, create_time) VALUES ('com.happy.framework.mybatis.entity', 'BaseEntity', 'id,creator,create_time,updater,update_time,version,deleted', '使用该基类，则需要表里有这些字段', now());

INSERT INTO gen_project_modify (project_name, project_code, project_package, project_path, modify_project_name, modify_project_code, modify_project_package, exclusions, modify_suffix, create_time) VALUES ('happy-boot', 'happy', 'com.happy', 'D:/skycoder/happy-boot', 'fast-boot', 'fast', 'com.fast', '.git,.idea,target,logs', 'java,xml,yml,txt', now());
INSERT INTO gen_project_modify (project_name, project_code, project_package, project_path, modify_project_name, modify_project_code, modify_project_package, exclusions, modify_suffix, create_time) VALUES ('happy-cloud', 'happy', 'com.happy', 'D:/skycoder/happy-cloud', 'fast-cloud', 'fast', 'com.fast', '.git,.idea,target,logs', 'java,xml,yml,txt', now());;
