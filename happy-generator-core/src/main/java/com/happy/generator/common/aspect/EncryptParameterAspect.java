package com.happy.generator.common.aspect;

import com.happy.generator.common.page.PageResult;
import com.happy.generator.common.utils.EncryptUtils;
import com.happy.generator.common.utils.Result;
import lombok.extern.slf4j.Slf4j;
import com.happy.generator.common.annotation.EncryptParameter;
...
public class EncryptParameterAspect {
     ...
     * @throws Throwable
     */
    @Around("execution(* com.happy.generator.controller.DataSourceController.*(..))")
    ...
    private void handleItem(Object item, boolean isDecrypt) {
        ...
        // 只处理在entity包下面的对象
        if (Objects.isNull(item.getClass().getPackage()) || !item.getClass().getPackage().getName().startsWith("com.happy.generator.entity")) {
            return;
        }
